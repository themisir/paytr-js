...
export type PayTRBasketItemArray = [string, string, number];

export type PayTRBasketItem = PayTRBasketItemObject | PayTRBasketItemArray;
...
export type PayTRConstructorParams = PayTRMerchantParams & {
  client?: Axios;
};
...
export type PayTRRefundStatus = "success" | "failed";
